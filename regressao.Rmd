...
**EXPLICAÇÃO**: *O Modelo explica bem os dados. Podemos ver que o p-valor são menores que 0.05 (5%), e são indicativos de que são bem representativos. Como o "r quadrado" é perto de 1 (representa 81,4% do modelo) podemos afirmar que o modelo é confiável com esses fatores. O valor estimado para o 'intercept' e para a Docentes permanentes estão dentro do intervalo de confiança com 95% de confiança. Quanto mais próximo da reta podemos perceber que menor é o erro, com isso vemos que a medida que cresce o número de Docentes permanentes, maior é a produção de artigos pelo programa. Podemos perceber que existe em maior quantidade o numero de universidades com menos de 40 Docentes permanentes.*
...
**EXPLICAÇÃO**: * Podemos ver que há um aumento no indicador "r quadrado"(84,5%), com isso aumentando a significancia do modelo, ou seja, descreve melhor o modelo. Podemos ver que o p-valor são menores que 0.05, ou seja, que o modelo é confiável para este conjunto de dados.*
